...
void tTSolver::solve(double* ETmiss, double* b, double* bb, double* lp, double* lm, 
  ...
  for (int i=0; i<pnuxt.size(); ++i) {
    ...
    if (fabs(lpbz_diff)<epsilon) { //circumvent singularity
      ...
      if (error==-1) {
	continue; //next pnux, pnubx solutions
      }
    }
    else {
...
//////////////////////////////////////////////////////////////////////////////////////////
void tTSolver::quartic(vector<double> polx, vector<double> *pnux, int& cubic_single_root_cmplx) {
...
//////////////////////////////////////////////////////////////////////////////////////////
void tTSolver::cubic(vector<double> polx, vector<double> *pnux) {
  if (polx[3] == 0.)
    quadratic(polx, pnux);
  else {
...
//////////////////////////////////////////////////////////////////////////////////////////
void tTSolver::quadratic(vector<double> polx, vector<double> *pnux) {
...
int tTSolver::algebraic_pz(double* b, double* lp, double mWp, double mt, 
			       double mb, double mlp, double mnu, double pnux, double pnuy,
			    double* pnuz) {
  ...
  double a1val = evalterma(&a1, pnux, pnuy);
  double a2val = evaltermb(&a2, pnux, pnuy);
  double b1val = evalterma(&b1, pnux, pnuy);
  double b2val = evaltermb(&b2, pnux, pnuy);
  ...
  if (radicant>=0.) {
    ...
    cout << "tTSolver: algebraic_pz: pnuz_a radicant=" << radicant 
  ...
  if (radicant>=0.) {
    ...
    cout << "tTSolver: algebraic_pz: pnuz_b radicant=" << radicant 
	 << " should never happen!" << endl;
  }
...
/////////////////////////////////////////////////////////////////
double tTSolver::evalterma(vector<double> *a1, double pnux, double pnuy) {
  return (*a1)[0]+(*a1)[1]*pnux+(*a1)[2]*pnuy;
}

/////////////////////////////////////////////////////////////////
double tTSolver::evaltermb(vector<double> *a2, double pnux, double pnuy) {
