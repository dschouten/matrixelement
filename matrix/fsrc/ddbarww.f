      SUBROUTINE SDDBARWW(P,ANS,RESET)
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION DDBARWW(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_21,GC_23,MZ, WZ, W(1,7))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      ...
      CALL FFV2_2(W(1,1),W(1,9),GC_16,ZERO, ZERO, W(1,10))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV2_0(W(1,10),W(1,2),W(1,8),GC_16,AMP(2))
      JAMP(1)=+AMP(1)+AMP(2)
      DDBARWW = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        ...
        ENDDO
        DDBARWW=DDBARWW+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
