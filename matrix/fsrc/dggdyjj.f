      SUBROUTINE SDGGDYJJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: G G > Z D D~ / G WEIGHTED=4
...
C     ----------
      ...
      REAL*8 FUNCTION DGGDYJJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      ...
      CALL FFV2_3_1(W(1,6),W(1,5),GC_21,GC_23,ZERO, ZERO, W(1,13))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 6
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        DGGDYJJ = DGGDYJJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
