      SUBROUTINE SUDBARWPJ(P,ANS,RESET)
C     
...
C     
C     Process: u d~ > w+ g WEIGHTED=3
C     *   Decay: w+ > e+ ve WEIGHTED=2
C     Process: c s~ > w+ g WEIGHTED=3
C     *   Decay: w+ > e+ ve WEIGHTED=2
C     
      IMPLICIT NONE
      INTEGER RESET
...
C     ----------
      ...
      REAL*8 FUNCTION UDBARWPJ(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.4.2, 2012-02-16
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        UDBARWPJ = UDBARWPJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
