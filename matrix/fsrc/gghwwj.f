      SUBROUTINE SGGHWWJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: G G > H > E+ VE E- VE~ G / Z HIG=1 HIW=1 QED=4
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION GGHWWJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL VVV1_1(W(1,1),W(1,2),GC_5,ZERO, ZERO, W(1,8))
      CALL FFV2_3(W(1,3),W(1,4),GC_17,MW, WW, W(1,9))
      CALL FFV2_3(W(1,6),W(1,5),GC_17,MW, WW, W(1,10))
      CALL VVS3_3(W(1,8),W(1,7),GC_8,MH, WH, W(1,11))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      CALL VVS2_0(W(1,10),W(1,9),W(1,11),GC_37,AMP(1))
      CALL VVV1_1(W(1,1),W(1,7),GC_5,ZERO, ZERO, W(1,12))
      CALL VVS3_3(W(1,12),W(1,2),GC_8,MH, WH, W(1,13))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL VVS2_0(W(1,10),W(1,9),W(1,13),GC_37,AMP(2))
      CALL VVV1_1(W(1,2),W(1,7),GC_5,ZERO, ZERO, W(1,14))
      CALL VVS3_3(W(1,1),W(1,14),GC_8,MH, WH, W(1,15))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      CALL VVS2_0(W(1,10),W(1,9),W(1,15),GC_37,AMP(3))
      CALL VVVS2_4(W(1,1),W(1,2),W(1,7),GC_9,MH, WH, W(1,16))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 4
      CALL VVS2_0(W(1,10),W(1,9),W(1,16),GC_37,AMP(4))
      JAMP(1)=+2*(+IMAG1*AMP(1)-IMAG1*AMP(2)+IMAG1*AMP(3)+IMAG1*AMP(4))
      JAMP(2)=+2*(-IMAG1*AMP(1)+IMAG1*AMP(2)-IMAG1*AMP(3)-IMAG1*AMP(4))
      GGHWWJ = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
        ...
        ENDDO
        GGHWWJ=GGHWWJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
