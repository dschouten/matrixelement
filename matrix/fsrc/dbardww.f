      SUBROUTINE SDBARDWW(P,ANS,RESET)
C     
...
C     
C     PROCESS: D~ D > W+ W- > E+ E- VE VE~ / A WEIGHTED=8
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION DBARDWW(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL FFV2_3_3(W(1,2),W(1,1),GC_21,GC_23,MZ, WZ, W(1,7))
      CALL FFV2_3(W(1,3),W(1,5),GC_16,MW, WW, W(1,8))
      CALL FFV2_3(W(1,6),W(1,4),GC_16,MW, WW, W(1,9))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      CALL VVV1_0(W(1,9),W(1,8),W(1,7),GC_7,AMP(1))
      CALL FFV2_1(W(1,1),W(1,8),GC_16,ZERO, ZERO, W(1,10))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV2_0(W(1,2),W(1,10),W(1,9),GC_16,AMP(2))
      JAMP(1)=-AMP(1)-AMP(2)
      DBARDWW = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        ...
        ENDDO
        DBARDWW=DBARDWW+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
