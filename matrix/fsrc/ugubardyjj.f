      SUBROUTINE SUGUBARDYJJ(P,ANS,RESET)
C     
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 50) THEN
          T=UGUBARDYJJ(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION UGUBARDYJJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      ...
      CALL FFV2_5_2(W(1,7),W(1,5),GC_22,GC_23,ZERO, ZERO, W(1,10))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 6
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        UGUBARDYJJ = UGUBARDYJJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
