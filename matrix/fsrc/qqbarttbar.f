      SUBROUTINE SQQBARTTBAR(P,ANS,RESET)
C     
...
C     
C     PROCESS: U U~ > T T~ > E+ VE E- VE~ B B~ QCD=2
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION QQBARTTBAR(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      CALL FFV1_0(W(1,13),W(1,12),W(1,9),GC_2,AMP(1))
      CALL FFV1_3(W(1,1),W(1,2),GC_5,ZERO, ZERO, W(1,14))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV1_0(W(1,13),W(1,12),W(1,14),GC_5,AMP(2))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_22,GC_23,MZ, WZ, W(1,15))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      CALL FFV2_5_0(W(1,13),W(1,12),W(1,15),GC_22,GC_23,AMP(3))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        QQBARTTBAR=QQBARTTBAR+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
