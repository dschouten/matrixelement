      SUBROUTINE SUUBARWWJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: U U~ > W+ W- > E+ E- VE VE~ G / A WEIGHTED=9
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION UUBARWWJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL FFV2_5_3(W(1,8),W(1,2),GC_22,GC_23,MZ, WZ, W(1,11))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      CALL VVV1_0(W(1,10),W(1,9),W(1,11),GC_7,AMP(1))
      CALL FFV2_2(W(1,8),W(1,9),GC_16,ZERO, ZERO, W(1,12))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV2_0(W(1,12),W(1,2),W(1,10),GC_16,AMP(2))
      CALL FFV1_1(W(1,2),W(1,7),GC_5,ZERO, ZERO, W(1,13))
      CALL FFV2_5_3(W(1,1),W(1,13),GC_22,GC_23,MZ, WZ, W(1,14))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      CALL VVV1_0(W(1,10),W(1,9),W(1,14),GC_7,AMP(3))
      CALL FFV2_2(W(1,1),W(1,9),GC_16,ZERO, ZERO, W(1,15))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 4
      CALL FFV2_0(W(1,15),W(1,13),W(1,10),GC_16,AMP(4))
      CALL FFV2_1(W(1,2),W(1,10),GC_16,ZERO, ZERO, W(1,16))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 5
      CALL FFV1_0(W(1,15),W(1,16),W(1,7),GC_5,AMP(5))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        UUBARWWJ=UUBARWWJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
