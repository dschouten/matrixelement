      SUBROUTINE SUGGDYJJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: G G > Z U U~ / G WEIGHTED=4
...
C     ----------
      ...
      REAL*8 FUNCTION UGGDYJJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL FFV1_1(W(1,6),W(1,1),GC_5,ZERO, ZERO, W(1,8))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV1_0(W(1,10),W(1,8),W(1,2),GC_5,AMP(2))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      ...
      CALL FFV2_5_1(W(1,6),W(1,5),GC_22,GC_23,ZERO, ZERO, W(1,13))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 4
      CALL FFV1_0(W(1,11),W(1,13),W(1,2),GC_5,AMP(4))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 6
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        UGGDYJJ = UGGDYJJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
