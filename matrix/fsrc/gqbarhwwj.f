      SUBROUTINE SGQBARHWWJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: G U~ > H > E+ VE E- VE~ U~ / Z HIG=1 HIW=1 QED=4
C     PROCESS: G C~ > H > E+ VE E- VE~ C~ / Z HIG=1 HIW=1 QED=4
C     PROCESS: G D~ > H > E+ VE E- VE~ D~ / Z HIG=1 HIW=1 QED=4
C     PROCESS: G S~ > H > E+ VE E- VE~ S~ / Z HIG=1 HIW=1 QED=4
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION GQBARHWWJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL FFV1_3(W(1,7),W(1,2),GC_6,ZERO, ZERO, W(1,8))
      CALL FFV2_3(W(1,3),W(1,4),GC_17,MW, WW, W(1,9))
      CALL FFV2_3(W(1,6),W(1,5),GC_17,MW, WW, W(1,10))
      CALL VVS3_3(W(1,1),W(1,8),GC_8,MH, WH, W(1,11))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        GQBARHWWJ=GQBARHWWJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
