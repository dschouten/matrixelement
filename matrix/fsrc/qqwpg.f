...
C     
C     Process: u d~ > e+ ve a / z WEIGHTED=6
C     Process: u d~ > mu+ vm a / z WEIGHTED=6
C     Process: c s~ > e+ ve a / z WEIGHTED=6
C     Process: c s~ > mu+ vm a / z WEIGHTED=6
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
      ...
      REAL*8 FUNCTION QQWPG(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.4.2, 2012-02-16
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,3),W(1,4),GC_16,MW, WW, W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,5),W(1,6),W(1,7),GC_25,AMP(1))
      CALL FFV1_2(W(1,3),W(1,5),GC_3,ZERO, ZERO, W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,8),W(1,4),W(1,6),GC_16,AMP(2))
      CALL FFV1_2(W(1,1),W(1,5),GC_2,ZERO, ZERO, W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,9),W(1,2),W(1,7),GC_16,AMP(3))
      CALL FFV1_1(W(1,2),W(1,5),GC_1,ZERO, ZERO, W(1,10))
C     Amplitude(s) for diagram number 4
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        QQWPG = QQWPG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
