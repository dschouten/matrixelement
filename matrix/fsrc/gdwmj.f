...
C     ----------
      ...
      REAL*8 FUNCTION GDWMJ(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.4.2, 2012-02-16
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,7),W(1,6),W(1,5),GC_16,AMP(1))
      CALL FFV1_1(W(1,6),W(1,1),GC_5,ZERO, ZERO, W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,8),W(1,5),GC_16,AMP(2))
      JAMP(1)=-AMP(1)-AMP(2)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        GDWMJ = GDWMJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
