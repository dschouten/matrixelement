      SUBROUTINE SQBARGHWWJ(P,ANS,RESET)
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION QBARGHWWJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL FFV1_3(W(1,7),W(1,1),GC_6,ZERO, ZERO, W(1,8))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        QBARGHWWJ=QBARGHWWJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
