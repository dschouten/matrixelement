      SUBROUTINE SGGTTBAR(P,ANS,RESET)
C     
...
C     
C     PROCESS: G G > T T~ > E+ VE E- VE~ B B~ QCD=2
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION GGTTBAR(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     ----------
      ...
      CALL VVV1_1(W(1,1),W(1,2),GC_4,ZERO, ZERO, W(1,9))
      CALL FFV2_3(W(1,3),W(1,4),GC_16,MW, WW, W(1,10))
      CALL FFV2_3(W(1,6),W(1,5),GC_16,MW, WW, W(1,11))
      CALL FFV2_1(W(1,7),W(1,10),GC_16,MT, WT, W(1,12))
      CALL FFV2_2(W(1,8),W(1,11),GC_16,MT, WT, W(1,13))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      CALL FFV1_0(W(1,13),W(1,12),W(1,9),GC_5,AMP(1))
      CALL FFV1_1(W(1,12),W(1,1),GC_5,MT, WT, W(1,14))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV1_0(W(1,13),W(1,14),W(1,2),GC_5,AMP(2))
      CALL FFV1_2(W(1,13),W(1,1),GC_5,MT, WT, W(1,15))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      CALL FFV1_0(W(1,15),W(1,12),W(1,2),GC_5,AMP(3))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        GGTTBAR=GGTTBAR+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
