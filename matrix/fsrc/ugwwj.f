...
C     
C     PROCESS: U G > W+ W- > E+ E- VE VE~ U / A WEIGHTED=9
C     PROCESS: C G > W+ W- > E+ E- VE VE~ C / A WEIGHTED=9
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION UGWWJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 4
      ...
      CALL FFV2_1(W(1,7),W(1,10),GC_16,ZERO, ZERO, W(1,16))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 5
      CALL FFV1_0(W(1,15),W(1,16),W(1,2),GC_5,AMP(5))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        UGWWJ=UGWWJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
