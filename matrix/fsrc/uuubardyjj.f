      SUBROUTINE SUUUBARDYJJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: U U~ > Z G G / G WEIGHTED=4
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 50) THEN
          T=UUUBARDYJJ(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION UUUBARDYJJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 1
      ...
      CALL FFV2_5_2(W(1,1),W(1,5),GC_22,GC_23,ZERO, ZERO, W(1,10))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      ...
      CALL FFV2_5_1(W(1,2),W(1,5),GC_22,GC_23,ZERO, ZERO, W(1,13))
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 6
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        UUUBARDYJJ = UUUBARDYJJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
