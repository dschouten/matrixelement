      SUBROUTINE SDDBARZAJ(P,ANS,RESET)
C     
...
C     
C     PROCESS: D D~ > E+ E- G WEIGHTED=5
C     PROCESS: D D~ > MU+ MU- G WEIGHTED=5
C     
      IMPLICIT NONE
      INTEGER RESET
C     
...
C     ----------
      ...
      REAL*8 FUNCTION DDBARZAJ(P,NHEL,IC)
C     
C     GENERATED BY MADGRAPH 5 V. 1.4.2, 2012-02-16
C     BY THE MADGRAPH DEVELOPMENT TEAM
C     PLEASE VISIT US AT HTTPS://LAUNCHPAD.NET/MADGRAPH5
...
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 2
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,8),GC_21,GC_23,AMP(2))
      CALL FFV1_1(W(1,2),W(1,5),GC_5,ZERO, ZERO, W(1,9))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 3
      CALL FFV1_0(W(1,1),W(1,9),W(1,7),GC_1,AMP(3))
C     AMPLITUDE(S) FOR DIAGRAM NUMBER 4
      CALL FFV2_3_0(W(1,1),W(1,9),W(1,8),GC_21,GC_23,AMP(4))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        DDBARZAJ = DDBARZAJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
